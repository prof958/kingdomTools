...
export const KINGDOM_ACTIVITIES: KingdomActivityDef[] = [
  ...
  },
  {
    ...
    outcomes: { criticalSuccess: "Your tax collectors are wildly successful! For the remainder of the Kingdom turn, gain a +2 circumstance bonus to Economy-based checks.", success: "Your tax collectors gather enough to grant you a +1 circumstance bonus to Economy-based checks for the remainder of the Kingdom turn. If you attempted to Collect Taxes during the previous turn, increase Unrest by 1.", failure: "As success, but the people are unhappy about taxes—increase Unrest by 1 (or by 2 if you attempted to Collect Taxes the previous turn).", criticalFailure: "Your tax collectors encounter resistance from the citizens and their attempts to gather Benefits Citizens bolster vacant leadership roles Leaders gain increased bonuses to aid each other Quell Dissent more efficiently Gain bonuses to Fortify, and Construct or Rebuild certain buildings easier +1 to Work Camp, Establish Trade Agreement, and Trade Commodities activities Ruin accumulates more slowly +1 to Magic checks, use Magic instead of Engineering Your citizens help mitigate failures Become trained in a Kingdom skill Recover from Unrest more quickly and lessen its effects Use Culture on checks to determine Unrest Draw upon reserve funds to avoid Ruin +2 to checks to end ongoing harmful events Use New Leadership and other activities more efficiently Cost of living expenses are reduced Gain RP when you critically succeed at Kingdom skills taxes are rebuffed. While the tax collectors still manage to gather enough taxes to support essential government needs, they have angered the kingdom's citizens and encouraged rebellious acts. Increase Unrest by 2, and choose one Ruin to increase by 1." },
  },
  {
    id: "craft-luxuries",
    name: "Craft Luxuries",
